<template>
    ...
    <div class="h-screen" :style="{paddingTop: `${navHeight}px`,}"><!-- pt-14 sm:pt-24    :style="{...rootStyle}" -->
		...
		<nav v-resize="onResizeNav" ref="nav" id="nav" class="fixed w-full z-30 top-0 bg-white shadow">
            <div class="w-full flex flex-wrap items-center justify-between mt-0 py-2 px-2 lg:px-4">
                <div class="flex items-center">
                    <router-link to="/">
                        <span class="uppercase text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r gradient-primary" href="#">
                            <svg
                                class="h-10 fill-current inline relative -top-0.5 mr-2 text-primary-moins"
                ...
                <div class="hidden sm:flex items-center w-auto z-20">
                    ...
                    <button class="py-4 px-8 rounded-full font-bold shadow text-white hover:underline hover:shadow-inner bg-gradient-to-tr gradient-primary hover:bg-gradient-to-br">
                        Action
                    </button>
                </div>
            </div>
        ...
        <footer v-resize="onResizeFooter" ref="footer" class="bg-gray-200 w-full">
			<div class="container mx-auto px-8">
				<div class="w-full flex flex-col md:flex-row py-6">
				<div class="flex-1 mb-6 text-secondary-plus">
					<a class="text-secondary-plus no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
					<!--Icon from: http://www.potlabicons.com/ -->
					<svg class="h-8 fill-current text-secondary-plus inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005">
				...
				<div class="flex-1">
					...
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">FAQ</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Help</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Support</a>
					</li>
					</ul>
				</div>
				<div class="flex-1">
					...
					<ul class="list-reset mb-6">
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Terms</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Privacy</a>
					</li>
					</ul>
				</div>
				<div class="flex-1">
					...
					<ul class="list-reset mb-6">
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Facebook</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Linkedin</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Twitter</a>
					</li>
					</ul>
				</div>
				<div class="flex-1">
					...
					<ul class="list-reset mb-6">
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Official Blog</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">About Us</a>
					</li>
					<li class="mt-2 inline-block mr-2 md:block md:mr-0">
						<a href="#" class="no-underline hover:underline text-gray-800 hover:text-secondary">Contact</a>
					</li>
					</ul>
				</div>
				</div>
